...
a persistence unit "servicioPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "servicio\pom.xml":
...
artifact ("servicio.war") is already built. You can build
